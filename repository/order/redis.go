...
import (
	...
	"github.com/gustafabayu/go-miserv-order/model"
...
func (r *RedisRepo) FindAll(ctx context.Context, page FindAllPage) (FindResult, error) {
	...
	if err != nil {
		return FindResult{}, fmt.Errorf("failed to get order from ids: %w", err)
	}
	...
	if err != nil {
		return FindResult{}, fmt.Errorf("failed to get order: %w", err)
	}
